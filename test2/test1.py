...
fig1 = sns.lineplot(x=predictDates.index, y=LSTMpredicted_reshape, label= 'LSTM Predict Price')
image1 = fig1.get_figure()
image1.savefig('./images/lstm.png',dpi = 400, overwrite = True)

plt.clf()

sns.lineplot(x = predictDates.index, y = testY_reshape, label = 'Actual Price')
fig2 = sns.lineplot(x=predictDates.index, y=GRUpredicted_reshape, label= 'GRU Predict Price')
image2 = fig2.get_figure()
image2.savefig('./images/gru.png',dpi = 400, overwrite = True)
