...
# img = fig.get_figure()
# img.savefig('heatmap.png',dpi = 400)
print(data.head())
print(data.tail())
...
# sns.lineplot(x = data.index, y = data['Weighted Price'], label = 'actual')

#fill missing values with previous day values
data['Weighted Price'].replace(0, np.nan, inplace=True)
data['Weighted Price'].fillna(method='ffill', inplace=True)

# fig  = sns.lineplot(x = data.index, y = data['Weighted Price'], label = 'corrected')
# img = fig.get_figure()
# img.savefig('./images/actual-corrected.png',dpi = 400, overwite = True)
# pyplot.show()
...
save_model(model,'./models/model-gru.hdf5',overwrite = True,include_optimizer = True)
...
pyplot.savefig('./images/figure-gru.png',dpi = 400)
pyplot.show()
